...
class DrenageLow
{
    ...
    public function result()
    {
        ...
        $additional_expenses = $calculators_data->getAdditionalExpenses('plate_grillage_low');
    ...
    protected function calculateAdditionalWork($additional_work, $works_total_cost, $materials_total_cost, $overhead_transport_total_cost)
    {
        ...
        $additional_work_options['concrete_foundation_device']['quantity'] = roundUp($this->form_values['grillage_width'] * $this->form_values['grillage_length'] + $this->form_values['grillage_length'] * $additional_work_options['concrete_foundation_device']['quantity_coeff'][0], 0);
        ...
        /* Гидроизоляция нижнего ростверка и плиты фундамента, технониколь, 1 слой */
        $additional_work_options['foundation_waterproofing_plinth']['quantity'] = roundUp($this->main_data['side_square'] + $this->form_values['grillage_length'] * $additional_work_options['foundation_waterproofing_plinth']['quantity_coeff'][0] * $this->form_values['grillage_height'] - $this->form_values['foundation_perimeter'] * $this->form_values['grillage_height'] + $this->form_values['plate_area'], 0);
        ...
        $additional_work_options['foundation_waterproofing_plinth']['cost'] = ($this->form_values['additionally_4'] == 'true') ? $additional_work_options['foundation_waterproofing_plinth']['quantity'] * $additional_work_options['foundation_waterproofing_plinth']['price'] : 0;

        /* Утепление боковых стенок фундамента, пеноплекс 50мм */
        $additional_work_options['side_wall_insulation']['quantity'] = roundUp($this->main_data['side_square'], 0);
        $additional_work_options['side_wall_insulation']['price'] = $additional_work_options['side_wall_insulation']['basic_price'][0];
        $additional_work_options['side_wall_insulation']['cost'] = ($this->form_values['additionally_5'] == 'true') ? $additional_work_options['side_wall_insulation']['quantity'] * $additional_work_options['side_wall_insulation']['price'] : 0;

        /* Утепление подошвы плиты и ростверка, внутренних стенок фундамента (отсечка "мостов" холода), пеноплекс 50мм */
        $additional_work_options['foundation_insulation']['quantity'] = roundUp($this->form_values['plate_area'] + $this->form_values['grillage_length'] * $additional_work_options['foundation_insulation']['quantity_coeff'][0] * $this->form_values['grillage_height'] - $this->form_values['foundation_perimeter'] * $this->form_values['grillage_height'], 0);
        $additional_work_options['foundation_insulation']['price'] = $additional_work_options['foundation_insulation']['basic_price'][0];
        $additional_work_options['foundation_insulation']['cost'] = ($this->form_values['additionally_6'] == 'true') ? $additional_work_options['foundation_insulation']['quantity'] * $additional_work_options['foundation_insulation']['price'] : 0;
        ...
        $additional_work_options['blind_area_device']['cost'] = ($this->form_values['additionally_7'] == 'true') ? $additional_work_options['blind_area_device']['quantity'] * $additional_work_options['blind_area_device']['price'] : 0;
        ...
        $additional_work_options['sewer_wiring']['cost'] = ($this->form_values['additionally_8'] == 'true') ? $additional_work_options['sewer_wiring']['quantity'] * $additional_work_options['sewer_wiring']['price'] : 0;
        ...
        $additional_work_options['electricity_supply']['price'] = roundUp($additional_work_options['electricity_supply']['basic_price'][0] + (
            ($works_total_cost + $materials_total_cost + $overhead_transport_total_cost +
                ($additional_work_options['geomembrane_installation']['cost'] + $additional_work_options['concrete_foundation_device']['cost'] + $additional_work_options['drainage_device']['cost'] + $additional_work_options['foundation_waterproofing_plinth']['cost'] + $additional_work_options['side_wall_insulation']['cost'] + $additional_work_options['foundation_insulation']['cost'] + $additional_work_options['blind_area_device']['cost'] + $additional_work_options['sewer_wiring']['cost'])
            ) / $additional_work_options['electricity_supply']['basic_coeff'][0]) * $additional_work_options['electricity_supply']['basic_coeff'][1], -2);
        $additional_work_options['electricity_supply']['cost'] = ($this->form_values['additionally_9'] == 'true') ? $additional_work_options['electricity_supply']['quantity'] * $additional_work_options['electricity_supply']['price'] : 0;
        ...
        $additional_work_options['trailer_rental']['cost'] = ($this->form_values['additionally_10'] == 'true') ? $additional_work_options['trailer_rental']['quantity'] * $additional_work_options['trailer_rental']['price'] : 0;
